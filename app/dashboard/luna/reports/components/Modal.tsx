 ...
 * focus restored to the trigger on close. Used by both the drill-down panel
 * and the export modal. `variant` controls layout (centered dialog vs. right
 * slide-over). Animations are gated behind motion-safe.
 */
